(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('ng2-file-upload/index'), require('@angular/material'), require('@angular/flex-layout'), require('angular-cropperjs')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', '@angular/common', 'ng2-file-upload/index', '@angular/material', '@angular/flex-layout', 'angular-cropperjs'], factory) :
	(factory((global['angular-upcrop'] = {}),global.core,global.common,global.index,global.material,global.flexLayout,global.angularCropperjs));
}(this, (function (exports,core,common,index,material,flexLayout,angularCropperjs) { 'use strict';
...
var UpcropUploadComponent = (function () {
    function UpcropUploadComponent() {
        ...
        this.uploader = new index.FileUploader({});
...
exports.UpcropUploadInstaComponent = UpcropUploadInstaComponent;
